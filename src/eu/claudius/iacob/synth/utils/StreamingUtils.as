...
public class StreamingUtils extends EventDispatcher {
    ...
    private var _proxy:ISynthProxy;
     ...
     * @constructor
     */
    public function StreamingUtils(workerBytes:ByteArray, proxy:ISynthProxy, autoPlayback:Boolean = true,
     ...
     */
    public function get proxy():ISynthProxy {
        return _proxy;
    }
     ...
     *          the synthesizer must execute. See `ISynthProxy.preRenderAudio()`.
     *
     * @param   privateClient
     ...
     */
    private static function _cloneTracks(tracks:Array):Array {
        var clone:Array = [];
        var i:int;
     ...
     */
    private static function _areTracksEmpty(tracks:Array):Boolean {
        var i:int;
        var numTracks:uint = tracks.length;
        var track:Array;
        for (i = 0; i < numTracks; i++) {
     ...
     */
    private static function _getTracksSlice(tracks:Array, sliceFrom:uint, sliceTo:uint):Array {
        var slice:Array = [];
     ...
     *          `tracks` argument.
     */
    private static function _splitTracksByType(tracks:Array):Object {
        var out:Object = {};
     ...
     */
    private static function _countInstructionsOf(tracksSlice:Array):uint {
     ...
     * @param obj
     */
    private static function _dumpObject(obj:Object):String {
        if (obj is String) {
